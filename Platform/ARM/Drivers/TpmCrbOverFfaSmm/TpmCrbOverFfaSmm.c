...
/**
  ...
  TpmCrbOverFfa StandaloneMm driver  doesn't support to register notification.
...
VOID
EFIAPI
TpmCrbOverFfaRegisterForNotification (
  IN OUT ARM_FFA_ARGS  *TpmArgs
  )
{
...
/**
  ...
  when a TPM service event occurs.
  TpmCrbOverFfa StandaloneMm driver doesn't support to unregister notification.
...
VOID
EFIAPI
TpmCrbOverFfaUnregisterFromNotification (
  IN OUT ARM_FFA_ARGS  *TpmArgs
  )
{
  SetResponseArgs (TpmArgs, TPM2_FFA_ERROR_NOTSUP, 0x00, 0x00, 0x00);
...
/**
  ...
  TpmCrbOverFfa StandaloneMm driver doesn't support to finish notification.
  ...
  )
{
  ...
  switch (Operation) {
    ...
    case TPM2_FFA_REGISTER_FOR_NOTIFICATION:
      TpmCrbOverFfaRegisterForNotification (TpmArgs);
      break;
    case TPM2_FFA_UNREGISTER_FROM_NOTIFICATION:
      TpmCrbOverFfaUnregisterFromNotification (TpmArgs);
      break;
    case TPM2_FFA_FINISH_NOTIFIED:
      TpmCrbOverFfaFinishNotified (TpmArgs);
      break;
